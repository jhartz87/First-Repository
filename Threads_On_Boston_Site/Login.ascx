...
<dnn:DnnJsInclude ID="DnnJsInclude1" runat="server" FilePath="bootstrap-3.3.4-dist/js/bootstrap.min.js" PathNameAlias="SkinPath" />
<dnn:DnnJsInclude ID="DnnJsInclude2" runat="server" FilePath="js/scripts.js" PathNameAlias="SkinPath" />
...
<div id="siteWrapper">
     <div id="contentWrapper">
            ...
            <div style="margin:0 auto;width:410px;">
                <img src="<%=SkinPath%>/Images/ThreadsLogo.png" style="margin-top:1in;margin-bottom:1in" />
