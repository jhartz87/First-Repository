<%@ Control Language="C#" AutoEventWireup="false" Inherits="PLC.ContactUsForm.ContactUsForm" CodeFile="ContactUsForm.ascx.cs" %>
...
<asp:Panel ID="PanelForm" runat="server">
    <div id="mc_embed_signup2" style="margin-top: 20px; max-width: 410px; width:100%">
       <div class="indicates-required">
        ...
        <div class="mc-field-group2">
            <label for="ddlRequestType">I'd like to speak to someone at DT Power Corp about</label>
        ...
        <div style="clear:both;margin-bottom:20px;margin-top:20px;">
            ...
            <div class="g-recaptcha" data-sitekey="6LdhvA0UAAAAAGxyFLf79B9qr-EQ7X0IfvjNjO_b"></div>
        </div>
