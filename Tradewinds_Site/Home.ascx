    ...
    <div id="MainImageCarouselPane" runat="server">
        <div data-cycle-slides="&gt; div" data-cycle-fx="fade" data-cycle-timeout="30000" data-cycle-speed="2000" class="slideshow-images cycle-slideshow hero-slideshow">
            <div class="homepage-slide">
                <img alt="" class="img-responsive" id="slide1" src="/Portals/_default/Skins/PLC/Images/homepage-images/AgricultureSlide.jpg" />
            </div>
            <div class="homepage-slide">
                <img alt="" class="img-responsive" id="slide2" src="/Portals/_default/Skins/PLC/Images/homepage-images/GovernmentSlide.jpg" />
            </div>
            <div class="homepage-slide">
                <img alt="" class="img-responsive" id="slide3" src="/Portals/_default/Skins/PLC/Images/homepage-images/AgricultureSlide.jpg" />
            </div>
            <div class="homepage-slide">
                <img alt="" class="img-responsive" id="slide4" src="/Portals/_default/Skins/PLC/Images/homepage-images/GovernmentSlide.jpg" />
            </div>
            <div class="homepage-slide">
                <img alt="" class="img-responsive" id="slide5" src="/Portals/_default/Skins/PLC/Images/homepage-images/AgricultureSlide.jpg" />
            </div>
            <div class="homepage-slide">
                <img alt="" class="img-responsive" id="slide6" src="/Portals/_default/Skins/PLC/Images/homepage-images/GovernmentSlide.jpg" />
            </div>
            <div class="homepage-slide">
                <img alt="" class="img-responsive" id="slide7" src="/Portals/_default/Skins/PLC/Images/homepage-images/AgricultureSlide.jpg" />
            </div>
        </div><!-- closing data-cycle-slides -->
  </div><!-- closing MainImageCarouselPane -->
</div><!-- closing carouselContainer -->

<div class="ourVideoContainer">
    <div class="container">
    <div class="row">
        <div class="col-md-6">
            <div id="OurStoryTextPane" runat="server">
                <h1>Rely On Tradewinds For Your Power.</h1>
                ...
                <p>Ut sem ipsum, auctor vitae euismod semper, pharetra sed orci. Suspendisse tincidunt ut eros ac fermentum. Donec sodales ac sapien ut posuere. 
                    Maecenas non urna eget tortor convallis placerat ac at magna. Nam ut lectus ac lectus posuere fringilla fermentum sit amet orci. 
                    Donec rhoncus tempus massa, quis dapibus augue iaculis et. Sed at condimentum ipsum, id congue mauris.</p>
            </div><!-- closing OurStoryTextPane -->
        </div><!-- closing col-md-6 -->
        <div class="col-md-6">
            <div id="OurStoryVideoPane" runat="server">
                <img class="video-image" src="/Portals/_default/Skins/PLC/Images/homepage-images/TradewindsVideo.png" alt="Tradewinds Video" />
            </div>
        </div><!-- closing col-md-6 -->
    </div><!-- closing row -->
    </div><!-- closing container -->
</div><!-- closing ourVideoContainer -->
...
<div class="tabsContainer">
    <div id="TabsPane" runat="server">
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#4a">Tab 4</a></li>
            <li><a data-toggle="tab" href="#5a">Tab 5</a></li>
...
<div class="container">
    <div class="row">
        <div class="col-md-9">
            <div id="NewsletterTextPane" runat="server">
                <h1>Power Alert <span class="italics">Newsletter</span></h1>
                <p>Interested in hearing about the latest news from Tradewinds Power Corp? Sign-up here, you can unsubscribe at any time.</p>
            </div><!-- closing NewsletterTextPane -->
        </div><!-- closing col-md-9 -->
        <div class="col-md-3">
            <div id="NewsletterButtonPane" runat="server">
                <button><a href="#" target="_blank">Sign Up Now!</a></button>
            </div>
        </div><!-- closing col-md-3 -->
    </div><!-- closing row -->
</div><!-- closing container -->
</div><!-- closing newsletterContainer -->

<div class="moreInfoContainer">
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div id="MoreInfoCol1Pane" runat="server">
                <h1>More Info Here</h1>
                <h2>NEW! This topic is super important</h2>
                <p>Ut sem ipsum, auctor vitae euismod semper, pharetra sed orci. Suspendisse tincidunt ut eros ac fermentum. Donec sodales ac sapien ut posuere. 
                    Maecenas non urna eget tortor convallis placerat ac at magna. Nam ut lectus ac lectus posuere fringilla fermentum sit amet orci. 
                    Donec rhoncus tempus massa, quis dapibus augue iaculis et. Sed at condimentum ipsum, id congue mauris.</p>
                <h2>Product & Materials You Can Rely On</h2>
                <p>Ut sem ipsum, auctor vitae euismod semper, pharetra sed orci. Suspendisse tincidunt ut eros ac fermentum. Donec sodales ac sapien ut posuere. 
                    Maecenas non urna eget tortor convallis placerat ac at magna. Nam ut lectus ac lectus posuere fringilla fermentum sit amet orci. 
                    Donec rhoncus tempus massa, quis dapibus augue iaculis et. Sed at condimentum ipsum, id congue mauris.</p>
            </div><!-- closing OurStoryTextPane -->
        ...
        <div class="col-md-6">
            <div id="MoreInfoCol2Pane" runat="server">
                <div class="col2">
                    <h2>Whatever We Touch Turns To Magic</h2>
                <p>Ut sem ipsum, auctor vitae euismod semper, pharetra sed orci. Suspendisse tincidunt ut eros ac fermentum. Donec sodales ac sapien ut posuere. 
                    Maecenas non urna eget tortor convallis placerat ac at magna. Nam ut lectus ac lectus posuere fringilla fermentum sit amet orci. 
                    Donec rhoncus tempus massa, quis dapibus augue iaculis et. Sed at condimentum ipsum, id congue mauris.</p>
                    <p>Ut sem ipsum, auctor vitae euismod semper, pharetra sed orci. Suspendisse tincidunt ut eros ac fermentum. Donec sodales ac sapien ut posuere. 
                    Maecenas non urna eget tortor convallis placerat ac at magna.</p>
                </div>
            </div>
        </div><!-- closing col-md-6 -->
    </div><!-- closing row -->
</div><!-- closing container -->
</div><!-- closing moreInfoContainer -->
...
<!-- grabs main nav Parent Link and puts it into dropdown menu as a link above the Child Links -->
<script type="text/javascript">
    if ($(window).width() > 1023) {
        $(function () {
            $('#mainNavBar > .nav > .dropdown > a').each(function (i, val) {
                //var parentCategory = $(this).text();
                $(this).next().prepend('<li class="parentLink">' + $(this)[0].outerHTML + '</li>');
            });
...
<!-- On Desktop, opens main nav dropdown on first click, makes dropdown height of the carousel image, matches carousel image to category -->
<!--On Mobile, gives mobile menu dropdown menu ability to open and display child links -->
<script>
    //navigation to parent item on second click
    $('#mainNavBar.main-nav-container .dropdown').on('touchstart click', function (e) {
        if ($(window).width() > 1023) {
            $('.cycle-slideshow').cycle('stop');
            var categoryIndex = $('#mainNavBar .dropdown').index($(this));
            //$('.cycle-slideshow').cycle('goto', categoryIndex);

            //var carouselHeight = $('.cycle-slide-active').outerHeight();
            //$('#mainNavBar ul.dropdown-menu').height(carouselHeight);

            var carouselHeight = $('.cycle-slide-active').outerHeight();
            $('#mainNavBar ul.dropdown-menu').attr("style", "height:" + carouselHeight + "px;");

            if ($(this).hasClass('opened')) {
                //location.assign($(this).attr('href'));
            }
            else {
                $(".main-nav-container .dropdown").removeClass("opened");
